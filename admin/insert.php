...
<a href="addInternship.php" class="btn  btn-primary btn-sm"><i class="fa fa-plus">Add New</i></a>
</div>
...
<?php while ($internship = mysqli_fetch_assoc($internships)) : ?>
    <?php if($internship['interview_date']> $currentdate){?>
        <div class="col-md-4 mt-2">
            <div class="card">
                <div class="card-header row" style="height: 140px;">
                    <h4 class="p-2 h4-responsive text-center my-auto"><b><?= $internship['category']; ?></b></h4>
                    
                    </div>
                    <div class="card-body" style="height: 200px;">
                    <h6 class="  card-title float-left" style="width: 50%;">Name: <?= $internship['nameOfCompany']; ?></h6>
                ...
                <div class="card-footer  row ml-2" style="width: 400px;">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="update.php?id=<?php echo $internship['id'] ?>" class="btn btn-primary btn-sm  waves-effect z-depth-0"><i class="fas fa-edit"></i> Update</a>
                    </div>
