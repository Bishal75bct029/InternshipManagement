...
<div class="container-fluid p-2 col-md-8">
	<div class="card">
		<div class="card-header">
			<h2 class="h2-responsive p-2 ml-3 text-primary">Edit Account</h2>
		</div>
		<div class="card-body">
				...
				<form class="p-3 grey-text" method="post" action="" enctype="multipart/form-data">
					<div class="row">					
						...
						<div class="text-center mt-4">
			              	<button class="btn btn-primary" type="submit" name="update"> <i class ="fas fa-edit"> Update </i><i class="fa fa-paper-plane-o ml-1"></i></button>
			            </div>					
						<div class="text-center mt-4">
							  <a class="btn btn-primary" href="./change_password.php"> <i class="fas fa-exchange-alt"> Change Password</i></a>
						</div>					
					</div>
				</form>
			</div>
