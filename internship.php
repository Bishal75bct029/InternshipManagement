  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header">
        <h2 class="p-2 text-center text-primary card-title" style="font-size: 40px; margin-top:10px;"><?=$category;?> at <?=$nameOfCompany;?>, <?=$location;?></h2>
      </div>
      <div class="card-body">
        ...
        <div class="text-justify py-2">
          ...
          <div class="url">
            <h4 class="h5-responsive">Important Link</h5>
